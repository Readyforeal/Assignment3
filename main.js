$(document).ready(function(){
    ...
    var completedMessage = "Congrats! You finished with " + correctAnswers + " out of 15 correct.";
    var tooSlowMessage = "Time's up. You finished with " + correctAnswers + " out of 15 correct. Thank you for participating.";

    $("#submit").on("click", function(){
        ValidateAnswers(completedMessage);
    });
    ...
    function InitTimer(time, display){
        ...
        setInterval(function(){
            ...
            if(minutes == 0 && seconds == 0){
                ValidateAnswers(tooSlowMessage);
            }
    ...
    function ValidateAnswers(message){
